...
![image.png](https://bce.bdstatic.com/doc/bce-doc/ISUDA/image_9420660.png)
...
![key.png](https://bce.bdstatic.com/doc/bce-doc/ISUDA/xx_b525a02.png)
...
![image.png](https://bce.bdstatic.com/doc/bce-doc/ISUDA/image_4d3a04a.png)

### 应用级别签名

签名算法使用 RS256，密钥是刚才下载的密钥，签名内容是 `"companyKey": "xxx", "appKey": "yyy"`，其中 `xxx` 是组织的短名字，看前面的介绍，而 `yyy` 是应用短名字，获取方法是在应用设置页：

![Screen Shot.png](https://bce.bdstatic.com/doc/bce-doc/ISUDA/Screen%20Shot%202021-03-12%20at%205.43.22%20PM_72d856f.png)
