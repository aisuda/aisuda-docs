...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.1.2
    restart: always
    ports:
      - '8090:8085'
    environment:
...
```
docker pull registry.baidubce.com/aisuda/aisuda:1.1.2
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.1.2
