...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.1.11
    restart: always
    ports:
      - '8090:8085'
    environment:
...
```
docker pull registry.baidubce.com/aisuda/aisuda:1.1.11
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.1.11
...
```
# 下载 aisuda 最新版本
docker run --rm -it --name aisuda registry.baidubce.com/aisuda/aisuda:1.1.11 bash
