...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.0.53
    restart: always
    ports:
      - '8088:8085'
    environment:
...
```
docker pull registry.baidubce.com/aisuda/aisuda:1.0.53
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.0.53
