...
镜像的下载地址是 `registry.baidubce.com/aisuda/aisuda`，比如 `registry.baidubce.com/aisuda/aisuda:1.8.0`
...
- 版本内容：
  - 🚀 组件功能与交互升级，提升组件可视化配置体验
    - 优化15个系统组件，属性面板交互、组件设计交互体验提升，主要包括
    ...
    - 事件动作配置面板升级，增强覆盖度，提升配置体验
      ...
      - 修复可视化配置展示问题
    - 支持30+组件默认值可视化配置，可通过公式编辑器快速关联数据域内其他变量并进行计算
    - 组件列表icon升级
  - 修复部分已知问题
  - 应用独立部署Java版本请升级到 jdk11
