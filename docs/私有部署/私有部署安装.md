...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.8.0
    ports:
      - '8090:8085'
    environment:
      # 数据库用户名
...
```bash
docker pull registry.baidubce.com/aisuda/aisuda:1.8.0
docker pull registry.baidubce.com/aisuda/mysql:8
docker pull registry.baidubce.com/aisuda/redis:5
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.8.0
