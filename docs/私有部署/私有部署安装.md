...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.4.0
    ports:
      - '8090:8085'
    environment:
      # 数据库用户名
...
可以试用到 2022 年 3 月的 license。

```

```
...
ISUDA_LDAP_URL="ldap://ldap.forumsys.com:389"
ISUDA_LDAP_BIND_DN="cn=read-only-admin,dc=example,dc=com"
ISUDA_LDAP_SEARCH_FILTER='(uid={{username}})'
ISUDA_LDAP_BIND_CREDENTIALS='password'
ISUDA_LDAP_SEARCH_BASE='dc=example,dc=com'
...
```bash
docker pull registry.baidubce.com/aisuda/aisuda:1.4.0
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.4.0
