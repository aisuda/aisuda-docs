...
services:
  web:
    image: registry.baidubce.com/aisuda/aisuda:1.1.19
    restart: always
    ports:
      - '8090:8085'
    environment:
...
```bash
docker pull registry.baidubce.com/aisuda/aisuda:1.1.19
docker save -o suda.tar registry.baidubce.com/aisuda/aisuda:1.1.19
